...
#ifndef SUB_GRAPH_ISO_HPP
#define SUB_GRAPH_ISO_HPP
...
// Custom do-nothing callback TODO: Remove unnecessary and unused types graph1 and graph2??
template < typename Graph1, typename Graph2 > struct vf2_empty_callback
{

    vf2_empty_callback(const Graph1& graph1, const Graph2& graph2)
    : graph1_(graph1), graph2_(graph2)
    {
    }
